...
//    }
    ...
    public void stud(android.view.View view) {
        Intent intent;
        intent = new Intent(getApplicationContext(),student.class);
        startActivity(intent);
    }

    public void teach(android.view.View view) {
        Intent intent;
        intent = new Intent(getApplicationContext(),teacher.class);
        startActivity(intent);
    }

    public void mark(android.view.View view) {
        Intent intent;
        intent = new Intent(getApplicationContext(),marks.class);
        startActivity(intent);
    }
